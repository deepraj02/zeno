...
import 'package:zeno/src/command_runner.dart';
...
void main() {
  group('ZenoCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ZenoCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = ZenoCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = ZenoCommandRunner();
